...
%                with different d in the fivebars robot.                  %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for optMode = optModeList % optmode
    ...
    if strcmp(optMode,'PKT')
        ...
        fprintf('   %02.2f   |',s.cost(optModeIndex,d_list(1))); 
        fprintf('   %02.2f   |',s.execTime(optModeIndex,d_list(1))); 
    ...
    for i=1:length(d_list) 
        if ~strcmp(optMode,'PKT')
            ...
            fprintf('   %02.2f   |',s.cost(optModeIndex,d_list(i))); 
            fprintf('   %02.2f   |',s.execTime(optModeIndex,d_list(i))); 
